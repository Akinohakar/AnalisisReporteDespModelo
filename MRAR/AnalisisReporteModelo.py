...
print("--------------------------Metricas de Desempeño del modelo seleccionado(2 capas)-----------------")
cm = confusion_matrix(test_y, anemia_nn_2.predict(test_x)) 
print(cm)
...
print("=============================================")
print("Metricas de rendimiento para modelo numero")
